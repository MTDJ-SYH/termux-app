...
public final class TermuxConstants {
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "Claude Code"; // Default: "Termux"
    /** Termux package name */
    ...
    /** Termux:API app name */
    public static final String TERMUX_API_APP_NAME = "Claude Code:API"; // Default: "Termux:API"
    ...
    public static final String TERMUX_BOOT_APP_NAME = "Claude Code:Boot"; // Default: "Termux:Boot"
    ...
    public static final String TERMUX_FLOAT_APP_NAME = "Claude Code:Float"; // Default: "Termux:Float"
    ...
    public static final String TERMUX_STYLING_APP_NAME = "Claude Code:Styling"; // Default: "Claude Code:Styling"
    ...
    public static final String TERMUX_TASKER_APP_NAME = "Claude Code:Tasker"; // Default: "Claude Code:Tasker"
    ...
    public static final String TERMUX_WIDGET_APP_NAME = "Claude Code:Widget"; // Default: "Claude Code:Widget"
